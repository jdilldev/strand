...
export const Dashboard = () => {
    ...
    return <Show when={data()} fallback={<p>Loading</p>}>
        <div class='p-4 flex flex-col justify-evenly items-start'>
            ...
            {showModal() && <div class='absolute top-1/4 z-10 w-1/2 h-1/2 bg-gray-100 flex flex-col justify-between self-center rounded-md'>
                <div class='p-3'>
            ...
            <ColorSwatchContainer heading='All threads'>
                {data().map((threadEntry: any) =>
                    <ColorSwatch brand={'dmc'} color={threadEntry.color} description={threadEntry.desc} code={threadEntry.code} />)}
